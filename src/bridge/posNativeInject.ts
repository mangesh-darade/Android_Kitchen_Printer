/**
 * Injected into POS WebView. Mirrors android/.../PosNativeJs.kt
 * Kitchen (ElintOm) uses:
 *   window.POSNativeBridge.printText(JSON.stringify({ text }))
 *   window.POSNative.printText({ text })
 *   window.posNativeBridge._printResult(ok)
 *   window.ElintPOSNative.printWebContent(text, mode)
 */
export const POS_NATIVE_WRAPPER_JS = `
(function() {
...
export const POS_NATIVE_PRINT_HOOK_JS = `
(function() {
